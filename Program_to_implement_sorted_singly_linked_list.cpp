/* The following C++ program creates a circular linked list by taking user input
   for the number of nodes and their values, and then traverses and displays the nodes in a linear manner. */
